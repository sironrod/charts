...
| cluster.dnsConfig | object | `{}` | DNS configuration for the cluster pods. |
| cluster.dnsPolicy | string | `""` | DNS policy for the cluster pods. |
| cluster.hostAliases | list | `[]` | Host aliases to inject into the cluster pods' /etc/hosts files. |
